...
KERNEL_DTB_IMAGE=rk3399-rockpi-4c-plus-radxa-8inch-touchscreen.img
...
# TODO: extract artifact: gpt.img (maybe this should happen in the git action?)
#       REL: ./build/rockdev/Image/gpt.img
#       /root/brewcraft-hub-aosp/build/rockdev/Image/gpt.img
